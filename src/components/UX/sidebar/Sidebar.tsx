...
const Sidebar = () => {
   ...
   const [isOpen, setIsOpen] = useState<boolean>(false); // Состояние для SendMessageModal

   // --- Добавляем состояния для модальных окон Success/Error ---
   ...
   // --- Функции для вызова модальных окон из SendMessageModal ---
   ...
   useEffect(() => {
      ...
      if (currentUser) {
         getIsFav(currentUser.id);
         getMessages(currentUser.id);
      }

      const handleUserUpdate = () => {
         const updatedUser = loadUserData();
         if (updatedUser) {
            getIsFav(updatedUser.id);
            getMessages(updatedUser.id);
         }
      };
   ...
   return (
      <div className="sidebar">
         {/* --- Рендерим модальные окна Success/Error --- */}
	...
	*/}
               ...
               <div className="sidebar-user__profile">
                  ...
                  <div className="sidebar-user__avatar">
                     <div className="sidebar-user__photo">
                        {user.avatar ? <img src={transformPhotoAvatar(user.avatar)} alt="Аватар пользователя" /> : <svg width="35" height="35" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <div>
            ...
            {/* Передаем обработчики в SendMessageModal */}
            <SendMessageModal
               isOpen={isOpen}
               setIsOpen={setIsOpen}
