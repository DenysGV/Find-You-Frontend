...
const AccountCommenItem = ({ id, user_id, text, date_comment, time_comment, author_nickname, children, setResult, accountId, onAction }: ICommentProps) => {
   ...
   const apiUrlRemove: string = 'https://check-you.blog/api/delete-comment';
   const apiUrlAddReport: string = 'https://check-you.blog/api/add-reports'; // Переименовал для ясности
